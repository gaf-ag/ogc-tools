...
public abstract class AbstractGML321ToJTSConverter<G, P, J extends Geometry>
	...
	public AbstractGML321ToJTSConverter(final GeometryFactory geometryFactory,
	...
	@Override
	public J createGeometry(final ObjectLocator locator, final G geometryType)
	...
	protected abstract J doCreateGeometry(final ObjectLocator locator, final G geometryType)
			throws ConversionFailedException;
