...
public class GML321ToJTSGeometryConverter implements
	...
	public GML321ToJTSGeometryConverter(final GeometryFactory geometryFactory,
	...
	public Geometry createGeometry(final ObjectLocator locator,
			final Object abstractGeometryType) throws ConversionFailedException {
		...
		if (abstractGeometryType == null) {
			...
			if (geometryPropertyType.isSetAbstractGeometry()) {
				return createGeometry(
						locator.property(
										"geometry",
								geometryPropertyType.getAbstractGeometry()).property(
										"value", geometryPropertyType.getAbstractGeometry().getValue()),
						geometryPropertyType.getAbstractGeometry().getValue());
			} else {
			...
			throw new ConversionFailedException(
					...
					MessageFormat.format(
									"Unexpected type [{0}].", abstractGeometryType.getClass().getName()));
		}
