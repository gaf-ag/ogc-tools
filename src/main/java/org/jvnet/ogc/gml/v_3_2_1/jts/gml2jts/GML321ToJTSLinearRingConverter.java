...
public class GML321ToJTSLinearRingConverter
		extends AbstractGML321ToJTSConverter<LinearRingType, LinearRingPropertyType, LinearRing> {
	...
	@Override
	protected LinearRing doCreateGeometry(final ObjectLocator locator,
			final LinearRingType linearRingType) throws ConversionFailedException {

		if (linearRingType.isSetPosOrPointPropertyOrPointRep()) {
			final ObjectLocator fieldLocator = locator
					.property("posOrPointPropertyOrPointRep", linearRingType.getPosOrPointPropertyOrPointRep());
			...
			final Coordinate[] coordinates = coordinateConverter
					.createCoordinates(
							locator.property(
									"posList", linearRingType.getPosList()), linearRingType
									.getPosList());
			...
			final Coordinate[] coordinates = coordinateConverter
					.createCoordinates(locator.property(
							"coordinates", linearRingType.getCoordinates()),
	...
	public LinearRing createGeometry(final ObjectLocator locator,
			final LinearRingPropertyType linearRingPropertyType)
			throws ConversionFailedException {

		if (linearRingPropertyType.isSetLinearRing()) {
			return createGeometry(
					locator.property(
							"linearRing", linearRingPropertyType.getLinearRing()),
