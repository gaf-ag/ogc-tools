...
public class JTSToGML321MultiPointConverter
		extends AbstractJTSToGML321Converter<MultiPointType, MultiPointPropertyType, MultiPoint> {
	...
	@Override
	protected MultiPointType doCreateGeometryType(final MultiPoint multiPoint) {
	...
	public MultiPointPropertyType createPropertyType(final MultiPoint multiPoint) {
	...
	public JAXBElement<MultiPointType> createElement(final MultiPoint multiPoint) {
